                                                                ...
                                                                <div className="card xl-blue member-card doctor">
                                                                    <div className="body">
                                                                        <div className="member-thumb">
                                                                            <img src={`http://localhost/php/hospital/doctordata/doctorimg/${r.image}`} className="img-fluid" alt="profile-image" />
                                                                        </div>
                                                                        <div className="detail">
                                                                            <h4 className="m-b-0">{r.fname}{r.lname}</h4>
                                                                            <p className="text-muted">{r.speciality}</p>
