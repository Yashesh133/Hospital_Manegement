...
function Index(props) {
    ...
    useEffect(() => {
        axios
            ...
            .then(function (response) {
                console.log(response.data.phpresult);
                setRes(response.data.phpresult);
                setloader(true);
            })
            .catch(function (error) {
                console.log(error);
            ...
            <div class="wrapper">
                ...
                <div className="main_header">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-5">
                                        <div className="text-right d-none d-md-block">
                                            <ul className="list-unstyled m-b-0">
                                                <li><a href="/signin" className="btn btn-link">Sign in</a> <a href="/signup" className="btn btn-link">sign
                                                    up</a></li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div id="navbar" data-aos="fade-down">
                        <div className="container">
                            <nav className="navbar  navbar-unset navbar-expand-lg navbar-light bg-light">
                        ...
                        <div className="container">
                            ...
                            <div className="slider_form row">
                                ...
                                <div className="col-lg-4">
                                    <button className="btn btn-primary btn-round btn-block m-t-0 m-b-0" onClick={senddata}>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <>
                                                <div className="col-lg-3 col-md-6 col-sm-12">
                                                    <div className="team-box text-center" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration={5000}>
                                                        <div className="doctor-pic"><img src={`http://localhost/php/hospital/doctordata/doctorimg/${item.image}`} alt="Dr. John" /></div>
                                                        <div className="doctor-info">
                                                            <h4>{item.fname} <span>{item.speciality}</span></h4>
                                                            ...
                                                            <a className="btn btn-simple btn-primary btn-round" href={`/doctor-profile/${item.id}`}>View More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </>
