...
function Profile_doctor() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost/php/hospital/doctordata/viewdoctor.php")
      .then(function (response) {
        console.log(response.data.phpresult);
        setDoctor(response.data.phpresult);
      })
                    ...
                    <div className="col-lg-4 col-md-12">
                      <div className="card profile-header">
                        <div className="body text-center">
                          <div className="profile-image"> <img src={`http://localhost/php/hospital/doctordata/doctorimg/${i.image}`}  /> </div>
                          <div>
                            <h4 className="m-b-0"><strong>{i.fname}{i.lname}</strong> Deo</h4>
