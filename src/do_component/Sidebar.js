...
function Sidebar(props) {
    ...
    useEffect(()=>{
        axios.get("http://localhost/php/hospital/doctordata/registerdata.php")
                        ...
                        <div className="tab-pane stretchRight active" id="dashboard">
                            <div className="menu">
                                <ul className="list">
                                    <li>
                                        <div className="user-info">
                                            ...
                                            <div className="detail">
                                                {
                                                    data.map((i)=>{
                                                        if (window.localStorage.getItem('hs_user_id') == i.id) {
                                                            return(
                                                                <>
                                                                    <h4>{i.username}</h4>
                                                                    <h5 className='h5-size'>{i.email}</h5>
                                                                </>
                                                            )
                                                        }
                                                    })
                                    ...
                                    <li><a href="/dash"><i className="zmdi zmdi-home" /><span>Dashboard</span></a></li>
                                    ...
                                    <li className="active open"><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-add" /><span>Doctors</span> </a>
                                        <ul className="ml-menu">
                                            ...
                                            <li className="active"><a href="/adddoctor">Add Doctor</a></li>
